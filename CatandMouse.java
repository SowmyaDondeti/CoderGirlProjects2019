...
public class CatandMouse
{
    public static void main(String[] args)
    {
        ...
        {
            System.out.println("You sneak quietly over to the lamp and try to climb it. The lamp buzzes slightly under your paws, and the light turns on with a click! The cat heard the lamp turn on and snaps awake. He chases you around the kitchen and back into your hole! (The End)");
            System.out.println("Try again later");
        }
        else if (input.equals("food"))
        {
            System.out.println("You sneak over to the cat's food dish. There's one piece of food on the floor and more in the dish. You're very hungry.\n" +
                    "What do you eat? Options: floor dish");
            input = keyboard.nextLine();
            if (input.equals("floor"))
            {
                System.out.println("You eat a large, tasty piece of cat food that was dropped on the floor. You were very quiet. The cat hasn't woken up yet.\n" +
                        "Where do you go next? Options: dish curtain");
                input = keyboard.nextLine();
                if (input.equals("dish"))
                {
                    System.out.println("The cat food rattles loudly as you climb into the cat food dish. The cat wakes up! And he knows exactly where you are. He's on you in an instant! You are lunch. :( We'll be sure to notify your next of kin. (The End)\n");
        ...
        {
            System.out.println("You sneak quietly across the room to the long curtains hanging by the window. The curtains are an easy climb. The cat is still asleep. You smell a barn just outside.\n" +
                    "Where do you go? Options: down window");
            input = keyboard.nextLine();
            if (input.equals("down"))
            {
                System.out.println("As you climb back down the curtain, the cat stretches and looks around the room. He notices the curtain hanging strangely and comes over to investigate. You have barely a moment to race back into your hole and try again tomorrow. (The End)");

            }
            else
            {
                System.out.println("You smell a barn nearby with fresh grain. You climb through the window and hide in the tall grass. There's spilled grain here that makes a tasty treat. By the time you reach the barn, you are well fed, and find a quiet spot in the hay for a nap. There is no cat in the barn. You're a happy mouse! (The End)");
                System.out.println("You Win");
            }
        }
    }
