...
public class ManyFunctions
{
    ...
    /**
     * Returns true if the letter is a vowel, or false otherwise. You can assume only letters are being sent as input
     * (not spaces or punctuation marks or anything else).
     */
    ...
    /**
     * Returns true if the letter is a consonant, or false otherwise. You can assume only letters are being sent as
     * input (not spaces or punctuation marks or anything else).
     * <p>
     * This can be written in 1 short line of code without typing out all the consonants in the alphabet.  Can you
     * figure out how?
     */
     ...
     * <p>
     * Just use this as an example of how the methods will be called, so you can figure out what they are supposed to
     * do.
     */
    public static void main(String[] args)
    {
        ...
        if (isConsonant('i'))
        {
            out.println("Error 17: isConsonant failed test.  Expect isConsonant('i') to be false, but got true.");
            testFailures++;
        }
        if (!isConsonant('b'))
        {
